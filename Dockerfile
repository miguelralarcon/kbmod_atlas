...
RUN python3.8 -m pip install pipenv astroalign opencv-python photutils
WORKDIR /app
...
# Docker run
# sudo docker run --restart=always -d -p 8187:8888 --runtime nvidia -e JUPYTER_TOKEN=dirac -e JUPYTER_ENABLE_LAB=yes -v /mnt/vast/atlas-tdo:/app/images -v /mnt/vast/red:/app/red --name kbmod kbmod
